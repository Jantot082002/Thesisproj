    ...
    <div class="col-md-6 card-box">
        <div class="card">
            <div class="card-body">
                ...
                $productDataQuery = "SELECT product_name, quantity FROM products";
    ...
    <div class="col-md-6 card-box">
        <div class="card">
            <div class="card-body">
                ...
                $expiredDataQuery = "SELECT product_name, quantity FROM expired_products";
    ...
    <div class="col-md-6 card-box">
        <div class="card">
            <div class="card-body">
                ...
                $stockDataQuery = "SELECT product_name, quantity FROM products"; // Adjust as needed
                $stockDataResult = $conn->query($stockDataQuery);

                $stockNames = [];
                $stockQuantities = [];

                if ($stockDataResult->num_rows > 0) {
                    while ($row = $stockDataResult->fetch_assoc()) {
                        $stockNames[] = $row['product_name'];
                        $stockQuantities[] = $row['quantity'];
                    }
                }
                $conn->close();
                ?>
